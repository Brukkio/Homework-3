...
class ShoppingCart:
  ...
  def modify_item(self, itemToPurchase):
    ...
    # This line of code represents what will happen when an item is not found
    if not tmodify_item:
      print('Item not found in the cart. Nothing modified')

      # This line of code represents a method to return the total quantity of all items in the shopping cart
  ...
  # This line of code represents a method to return the total cost of all items in the shopping cart
  ...
  # This line of code represents a method to print the total cost of the cart
  ...
  # This line of code represents a method to print the item's description
  def print_descriptions(self):
    if len(self.cart_items) == 0:
      ...
      # This line of code represents a method to display the menu options and based on user's choice perform the operation
...
def print_menu(newCart):
  ...
  menu = ('\nMENU\n'
          ...
          'q - Quit\n')
  # These line of code represents what will happen when you choose an option from the menu
  command = ''
  while (command != 'q'):
    print(menu)
